...
describe('MarkdownViewer', () => {
  it('renders markdown headings and paragraph content', () => {
    ...
    expect(document.body.querySelector('[data-sdk-ui="markdown-viewer"]')).toHaveAttribute('data-slot', 'markdown-viewer');
  ...
  it('renders markdown lists and fenced code blocks', () => {
    ...
    expect(document.body.querySelector('[data-sdk-ui="markdown-viewer-code-block"]')).toHaveAttribute('data-slot', 'markdown-viewer-code-block');
  });

  it('shows an empty markdown state when content is blank', () => {
    render(<MarkdownViewer content={'   '} />);

    expect(screen.getByText('No markdown content')).toHaveAttribute('data-slot', 'markdown-viewer-empty');
  });
});
