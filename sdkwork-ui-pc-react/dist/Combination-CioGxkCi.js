import { a as e, n as t } from "./dist-5AX1ca2q.js";
import { t as n } from "./createLucideIcon-19v64F-t.js";
import { i as r, n as i, o as a, r as o, s } from "./dist-D2r-1rhT.js";
import { n as c, t as l } from "./dist-DUsjyQ_S.js";
...
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/@radix-ui+react-collection@_e688633bd3d45f22d4731832f48e78f7/node_modules/@radix-ui/react-collection/dist/index.mjs
function x(n) {
	let r = n + "CollectionProvider", [i, o] = a(r), [s, c] = i(r, {
	...
	l.displayName = r;
	let d = n + "CollectionSlot", f = t(d), m = u.forwardRef((t, n) => {
		let { scope: r, children: i } = t;
		return /* @__PURE__ */ p(f, {
			ref: e(n, c(d, r).collectionRef),
			children: i
		});
	});
	m.displayName = d;
	let h = n + "CollectionItemSlot", g = "data-radix-collection-item", _ = t(h), v = u.forwardRef((t, n) => {
		let { scope: r, children: i, ...a } = t, o = u.useRef(null), s = e(n, o), l = c(h, r);
		return u.useEffect(() => (l.itemMap.set(o, {
			ref: o,
			...a
		}), () => void l.itemMap.delete(o))), /* @__PURE__ */ p(_, {
			[g]: "",
			ref: s,
			children: i
		});
	...
	v.displayName = h;
	function y(e) {
		let t = c(n + "CollectionConsumer", e);
...
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/@radix-ui+react-use-escape-_6b25b701476c890f81bf7729a06c1a7a/node_modules/@radix-ui/react-use-escape-keydown/dist/index.mjs
...
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/@radix-ui+react-dismissable_d5c7d5469b48563cb554b47e6f160aef/node_modules/@radix-ui/react-dismissable-layer/dist/index.mjs
var C = "DismissableLayer", w = "dismissableLayer.update", T = "dismissableLayer.pointerDownOutside", E = "dismissableLayer.focusOutside", D, O = u.createContext({
	...
	let { disableOutsidePointerEvents: r = !1, onEscapeKeyDown: i, onPointerDownOutside: a, onFocusOutside: o, onInteractOutside: c, onDismiss: d, ...f } = t, m = u.useContext(O), [h, g] = u.useState(null), _ = h?.ownerDocument ?? globalThis?.document, [, v] = u.useState({}), y = e(n, (e) => g(e)), b = Array.from(m.layers), [x] = [...m.layersWithOutsidePointerEventsDisabled].slice(-1), C = b.indexOf(x), T = h ? b.indexOf(h) : -1, E = m.layersWithOutsidePointerEventsDisabled.size > 0, k = T >= C, A = M((e) => {
		let t = e.target, n = [...m.branches].some((e) => e.contains(t));
		!k || n || (a?.(e), c?.(e), e.defaultPrevented || d?.());
	}, _), j = N((e) => {
		let t = e.target;
		[...m.branches].some((e) => e.contains(t)) || (o?.(e), c?.(e), e.defaultPrevented || d?.());
	}, _);
	return S((e) => {
		T === m.layers.size - 1 && (i?.(e), !e.defaultPrevented && d && (e.preventDefault(), d()));
	}, _), u.useEffect(() => {
		if (h) return r && (m.layersWithOutsidePointerEventsDisabled.size === 0 && (D = _.body.style.pointerEvents, _.body.style.pointerEvents = "none"), m.layersWithOutsidePointerEventsDisabled.add(h)), m.layers.add(h), P(), () => {
			r && (m.layersWithOutsidePointerEventsDisabled.delete(h), m.layersWithOutsidePointerEventsDisabled.size === 0 && (_.body.style.pointerEvents = D));
		};
	}, [
		h,
		_,
		...
		onFocusCapture: s(t.onFocusCapture, j.onFocusCapture),
		onBlurCapture: s(t.onBlurCapture, j.onBlurCapture),
		onPointerDownCapture: s(t.onPointerDownCapture, A.onPointerDownCapture)
	});
});
k.displayName = C;
var A = "DismissableLayerBranch", j = u.forwardRef((t, n) => {
	let r = u.useContext(O), i = u.useRef(null), a = e(n, i);
	return u.useEffect(() => {
		let e = i.current;
		if (e) return r.branches.add(e), () => {
			r.branches.delete(e);
		};
	}, [r.branches]), /* @__PURE__ */ p(l.div, {
		...t,
		ref: a
	});
});
...
function M(e, t = globalThis?.document) {
	let n = i(e), r = u.useRef(!1), a = u.useRef(() => {});
	return u.useEffect(() => {
		let e = (e) => {
...
function N(e, t = globalThis?.document) {
	let n = i(e), r = u.useRef(!1);
	return u.useEffect(() => {
		let e = (e) => {
			e.target && !r.current && F(E, n, { originalEvent: e }, { discrete: !1 });
		};
...
function F(e, t, n, { discrete: r }) {
	...
	t && i.addEventListener(e, t, { once: !0 }), r ? c(i, a) : i.dispatchEvent(a);
}
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/@radix-ui+react-focus-guard_78030b900106b9bb2b519bd73b8e579e/node_modules/@radix-ui/react-focus-guards/dist/index.mjs
var ee = 0, I = null;
function te() {
	u.useEffect(() => {
		I ||= {
...
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/@radix-ui+react-focus-scope_8aad341e518bece285c80448ad25e837/node_modules/@radix-ui/react-focus-scope/dist/index.mjs
var L = "focusScope.autoFocusOnMount", re = "focusScope.autoFocusOnUnmount", ie = {
	bubbles: !1,
	cancelable: !0
}, ae = "FocusScope", oe = u.forwardRef((t, n) => {
	let { loop: r = !1, trapped: a = !1, onMountAutoFocus: o, onUnmountAutoFocus: s, ...c } = t, [d, f] = u.useState(null), m = i(o), h = i(s), g = u.useRef(null), _ = e(n, (e) => f(e)), v = u.useRef({
		paused: !1,
		pause() {
			this.paused = !0;
		},
...
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/@radix-ui+react-id@1.1.2_@types+react@19.2.14_react@19.2.4/node_modules/@radix-ui/react-id/dist/index.mjs
var _e = u.useId || (() => void 0), ve = 0;
function ye(e) {
	let [t, n] = u.useState(_e());
	return r(() => {
		e || n((e) => e ?? String(ve++));
	}, [e]), e || (t ? `radix-${t}` : "");
}
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/@floating-ui+utils@0.2.11/node_modules/@floating-ui/utils/dist/floating-ui.utils.mjs
var be = [
	"top",
	"right",
	"bottom",
...
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/@floating-ui+core@1.7.5/node_modules/@floating-ui/core/dist/floating-ui.core.mjs
function He(e, t, n) {
...
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/@floating-ui+utils@0.2.11/node_modules/@floating-ui/utils/dist/floating-ui.utils.dom.mjs
function rt() {
...
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/@floating-ui+dom@1.7.6/node_modules/@floating-ui/dom/dist/floating-ui.dom.mjs
function xt(e) {
...
var xn = bn;
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/@radix-ui+react-use-size@1._51efd50bb1096f9c0ac03b162fbe37a6/node_modules/@radix-ui/react-use-size/dist/index.mjs
function Sn(e) {
...
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/@radix-ui+react-popper@1.3._a371cc4f3312d8f92861bfa1fa7c6272/node_modules/@radix-ui/react-popper/dist/index.mjs
var Cn = "Popper", [wn, Tn] = a(Cn), [En, Dn] = wn(Cn), On = (e) => {
...
On.displayName = Cn;
var kn = "PopperAnchor", An = u.forwardRef((t, n) => {
	let { __scopePopper: r, virtualRef: i, ...a } = t, o = Dn(kn, r), s = u.useRef(null), c = o.onAnchorChange, d = e(n, u.useCallback((e) => {
		s.current = e, e && c(e);
	}, [c])), f = u.useRef(null);
	u.useEffect(() => {
		if (!i) return;
		let e = f.current;
		f.current = i.current, e !== f.current && c(f.current);
	});
	let m = o.placementState && Bn(o.placementState), h = m?.[0], g = m?.[1];
	return i ? null : /* @__PURE__ */ p(l.div, {
...
An.displayName = kn;
var jn = "PopperContent", [Mn, Nn] = wn(jn), Pn = u.forwardRef((t, n) => {
	let { __scopePopper: a, side: o = "bottom", sideOffset: s = 0, align: c = "center", alignOffset: d = 0, arrowPadding: f = 0, avoidCollisions: m = !0, collisionBoundary: h, collisionPadding: g = 0, sticky: _ = "partial", hideWhenDetached: v = !1, updatePositionStrategy: y = "optimized", onPlaced: b, ...x } = t, S = Dn(jn, a), [C, w] = u.useState(null), T = e(n, (e) => w(e)), [E, D] = u.useState(null), O = Sn(E), k = O?.width ?? 0, A = O?.height ?? 0, j = o + (c === "center" ? "" : "-" + c), M = typeof g == "number" ? g : {
		top: 0,
		right: 0,
		bottom: 0,
		left: 0,
...
var Vn = On, Hn = An, Un = Pn, Wn = Ln, Gn = "Portal", Kn = u.forwardRef((e, t) => {
	let { container: n, ...i } = e, [a, o] = u.useState(!1);
	r(() => o(!0), []);
...
Kn.displayName = Gn;
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/@radix-ui+react-roving-focu_08c2e0f6f672d79e28443dc3874fd3cd/node_modules/@radix-ui/react-roving-focus/dist/index.mjs
var qn = "rovingFocusGroup.onEntryFocus", Jn = {
	bubbles: !1,
	cancelable: !0
}, Yn = "RovingFocusGroup", [Xn, Zn, Qn] = x(Yn), [$n, er] = a(Yn, [Qn]), [tr, nr] = $n(Yn), rr = u.forwardRef((e, t) => /* @__PURE__ */ p(Xn.Provider, {
...
rr.displayName = Yn;
var ir = u.forwardRef((t, n) => {
	let { __scopeRovingFocusGroup: r, orientation: a, loop: c = !1, dir: d, currentTabStopId: f, defaultCurrentTabStopId: m, onCurrentTabStopIdChange: h, onEntryFocus: g, preventScrollOnEntryFocus: _ = !1, ...y } = t, b = u.useRef(null), x = e(n, b), S = o(d), [C, w] = v({
		prop: f,
		defaultProp: m ?? null,
		onChange: h,
		caller: Yn
	}), [T, E] = u.useState(!1), D = i(g), O = Zn(r), k = u.useRef(!1), [A, j] = u.useState(0);
	return u.useEffect(() => {
		let e = b.current;
		...
		children: /* @__PURE__ */ p(l.div, {
			...
			onBlur: s(t.onBlur, () => E(!1))
		})
	});
}), ar = "RovingFocusGroupItem", or = u.forwardRef((e, t) => {
	let { __scopeRovingFocusGroup: n, focusable: r = !0, active: i = !1, tabStopId: a, children: o, ...c } = e, d = ye(), f = a || d, m = nr(ar, n), h = m.currentTabStopId === f, g = Zn(n), { onFocusableItemAdd: _, onFocusableItemRemove: v, currentTabStopId: y } = m;
	return u.useEffect(() => {
		if (r) return _(), () => v();
	}, [
		r,
		...
		children: /* @__PURE__ */ p(l.span, {
			...
			onFocus: s(e.onFocus, () => m.onItemFocus(f)),
...
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/react-remove-scroll-bar@2.3_25ad6fb9fe75be4391ed3c9752b30d68/node_modules/react-remove-scroll-bar/dist/es2015/constants.js
var Tr = "right-scroll-bar-position", Er = "width-before-scroll-bar", Dr = "with-scroll-bars-hidden", Or = "--removed-body-scroll-bar-size";
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/use-callback-ref@1.3.3_@types+react@19.2.14_react@19.2.4/node_modules/use-callback-ref/dist/es2015/assignRef.js
function kr(e, t) {
	return typeof e == "function" ? e(t) : e && (e.current = t), e;
}
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/use-callback-ref@1.3.3_@types+react@19.2.14_react@19.2.4/node_modules/use-callback-ref/dist/es2015/useRef.js
function Ar(e, t) {
	var n = f(function() {
		return {
			value: e,
...
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/use-callback-ref@1.3.3_@types+react@19.2.14_react@19.2.4/node_modules/use-callback-ref/dist/es2015/useMergeRef.js
...
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/use-sidecar@1.1.3_@types+react@19.2.14_react@19.2.4/node_modules/use-sidecar/dist/es2015/medium.js
function Pr(e) {
	return e;
}
function Fr(e, t) {
...
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/use-sidecar@1.1.3_@types+react@19.2.14_react@19.2.4/node_modules/use-sidecar/dist/es2015/exports.js
var Lr = function(e) {
...
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/react-remove-scroll@2.7.2_@types+react@19.2.14_react@19.2.4/node_modules/react-remove-scroll/dist/es2015/medium.js
...
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/get-nonce@1.0.1/node_modules/get-nonce/dist/es2015/index.js
var Hr, Ur = function() {
	if (Hr) return Hr;
	if (typeof __webpack_nonce__ < "u") return __webpack_nonce__;
};
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/react-style-singleton@2.2.3_19dd01ab2b695c353a9afad65534024e/node_modules/react-style-singleton/dist/es2015/singleton.js
function Wr() {
...
//#endregion
//#region ../../sdkwork-im/apps/sdkwork-im-pc/node_modules/.pnpm-codex-new/react-remove-scroll@2.7.2_@types+react@19.2.14_react@19.2.4/node_modules/react-remove-scroll/dist/es2015/sidecar.js
...
//# sourceMappingURL=Combination-CioGxkCi.js.map