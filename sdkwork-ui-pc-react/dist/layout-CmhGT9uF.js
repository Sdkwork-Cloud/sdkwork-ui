...
import { t } from "./chevron-down-C54jMGR6.js";
import { t as n } from "./chevron-right-Csp3Jz6f.js";
import { i as r, n as i, o as a, r as o, s, t as c } from "./dist-ZP7iWfNQ.js";
import { o as l, t as u } from "./dist-Dt-KO-jK.js";
import { t as d } from "./dist-DVI7OL9x.js";
...
//#region ../../sdkwork-birdcoder/node_modules/.pnpm/@radix-ui+react-scroll-area_0f9d166bb879c42c8f09d1e28e4fe5ef/node_modules/@radix-ui/react-scroll-area/dist/index.mjs
function D(e, t) {
	return f.useReducer((e, n) => t[e][n] ?? e, e);
}
var O = "ScrollArea", [k, A] = a(O), [ee, j] = k(O), te = f.forwardRef((e, t) => {
	let { __scopeScrollArea: n, type: r = "hover", dir: i, scrollHideDelay: a = 600, ...s } = e, [c, d] = f.useState(null), [p, m] = f.useState(null), [h, g] = f.useState(null), [_, v] = f.useState(null), [y, b] = f.useState(null), [x, S] = f.useState(0), [C, w] = f.useState(0), [E, D] = f.useState(!1), [O, k] = f.useState(!1), A = l(t, (e) => d(e)), j = o(i);
...
te.displayName = O;
var ne = "ScrollAreaViewport", re = f.forwardRef((e, t) => {
	let { __scopeScrollArea: n, children: r, nonce: i, ...a } = e, o = j(ne, n), s = l(t, f.useRef(null), o.onViewportChange);
...
var ae = f.forwardRef((e, t) => {
	...
	}, [i.scrollArea, i.scrollHideDelay]), /* @__PURE__ */ T(c, {
		present: n || a,
	...
	let { forceMount: n, ...r } = e, i = j(M, e.__scopeScrollArea), a = e.orientation === "horizontal", o = Oe(() => u("SCROLL_END"), 100), [l, u] = D("hidden", {
	...
	return f.useEffect(() => {
		...
		children: /* @__PURE__ */ T(ce, {
			...
			...r,
			ref: t,
			onPointerEnter: s(e.onPointerEnter, () => u("POINTER_ENTER")),
			onPointerLeave: s(e.onPointerLeave, () => u("POINTER_LEAVE"))
		})
	});
}), se = f.forwardRef((e, t) => {
	let n = j(M, e.__scopeScrollArea), { forceMount: r, ...i } = e, [a, o] = f.useState(!1), s = e.orientation === "horizontal", l = Oe(() => {
		if (n.viewport) {
			let e = n.viewport.offsetWidth < n.viewport.scrollWidth, t = n.viewport.offsetHeight < n.viewport.scrollHeight;
			o(s ? e : t);
		}
	}, 10);
	return N(n.viewport, l), N(n.content, l), /* @__PURE__ */ T(c, {
		present: r || a,
		children: /* @__PURE__ */ T(ce, {
			"data-state": a ? "visible" : "hidden",
			...i,
	...
	let { sizes: n, onSizesChange: r, ...i } = e, a = j(M, e.__scopeScrollArea), [o, s] = f.useState(), c = f.useRef(null), u = l(t, c, a.onScrollbarXChange);
	return f.useEffect(() => {
		...
		style: {
			...
			"--radix-scroll-area-thumb-width": Se(n) + "px",
			...e.style
		},
		...
		onResize: () => {
			c.current && a.viewport && o && r({
				...
				scrollbar: {
					...
					paddingStart: be(o.paddingLeft),
					paddingEnd: be(o.paddingRight)
				}
			});
		}
	});
}), ue = f.forwardRef((e, t) => {
	let { sizes: n, onSizesChange: r, ...i } = e, a = j(M, e.__scopeScrollArea), [o, s] = f.useState(), c = f.useRef(null), u = l(t, c, a.onScrollbarYChange);
	return f.useEffect(() => {
		c.current && s(getComputedStyle(c.current));
	}, [c]), /* @__PURE__ */ T(pe, {
		...
		style: {
			...
			"--radix-scroll-area-thumb-height": Se(n) + "px",
			...e.style
		},
		...
		onResize: () => {
			c.current && a.viewport && o && r({
				...
				scrollbar: {
					...
					paddingStart: be(o.paddingTop),
					paddingEnd: be(o.paddingBottom)
				}
			});
		}
	});
}), [de, fe] = k(M), pe = f.forwardRef((e, t) => {
	let { __scopeScrollArea: n, sizes: r, hasThumb: a, onThumbChange: o, onThumbPointerUp: c, onThumbPointerDown: d, onThumbPositionChange: p, onDragScroll: m, onWheelScroll: h, onResize: g, ..._ } = e, v = j(M, n), [y, b] = f.useState(null), x = l(t, (e) => b(e)), S = f.useRef(null), C = f.useRef(""), w = v.viewport, E = r.content - r.viewport, D = i(h), O = i(p), k = Oe(g, 10);
	function A(e) {
		S.current && m({
	...
	return f.useEffect(() => {
		...
		E,
		D
	]), f.useEffect(O, [r, O]), N(y, k), N(v.content, k), /* @__PURE__ */ T(de, {
		scope: n,
		scrollbar: y,
		hasThumb: a,
		onThumbChange: i(o),
		onThumbPointerUp: i(c),
	...
	let { __scopeScrollArea: n, style: r, ...i } = e, a = j(me, n), o = fe(me, n), { onThumbPositionChange: c } = o, d = l(t, (e) => o.onThumbChange(e)), p = f.useRef(void 0), m = Oe(() => {
	...
	return f.useEffect(() => {
		...
		if (e) {
			let t = () => {
				m(), p.current || (p.current = De(e, c), c());
			};
...
//#endregion
//#region ../../sdkwork-birdcoder/node_modules/.pnpm/@radix-ui+react-separator@1_e092326ab2e0108c5fcac1c43e5a8410/node_modules/@radix-ui/react-separator/dist/index.mjs
...
//#endregion
//#region ../../sdkwork-birdcoder/node_modules/.pnpm/react-resizable-panels@4.11_4b93f5e2c692168ec3ba6c8c6db99693/node_modules/react-resizable-panels/dist/react-resizable-panels.js
function Ve(e, t) {
...
var yn = f.forwardRef(({ actions: r, children: i, className: a, defaultExpanded: o = !0, description: s, expanded: c, meta: l, onExpandedChange: u, title: d, ...p }, m) => {
		...
		children: [/* @__PURE__ */ E("div", {
			...
			children: [/* @__PURE__ */ E("button", {
				...
				children: [/* @__PURE__ */ E("div", {
					...
					children: T(v ? t : n, { className: "h-3.5 w-3.5" })
				})]
			}), r ? /* @__PURE__ */ T("div", {
...
//# sourceMappingURL=layout-CmhGT9uF.js.map