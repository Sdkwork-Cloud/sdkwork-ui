...
import { t as n } from "./chevron-down-ScI7UQ8M.js";
import { t as r } from "./chevron-right-BoV_LaPW.js";
import { c as i, d as a, i as o, n as s, r as c, t as l, u } from "./dist-CNLTsenx.js";
import { t as d } from "./dist-CwQR3bD-.js";
import { t as f } from "./dist-CI1QAOem.js";
...
//#region ../../sdkwork-appbase/node_modules/.pnpm/@radix-ui+react-scroll-area_155614c2fe5222bb9b221068b09efefc/node_modules/@radix-ui/react-scroll-area/dist/index.mjs
function O(e, t) {
...
//#endregion
//#region ../../sdkwork-appbase/node_modules/.pnpm/@radix-ui+react-separator@1_aa2d5d85a81bb702303f0548763b9797/node_modules/@radix-ui/react-separator/dist/index.mjs
...
//#endregion
//#region ../../sdkwork-appbase/node_modules/.pnpm/react-resizable-panels@4.9._b4cfc959ce66d0e796fb8c2dbfd8578f/node_modules/react-resizable-panels/dist/react-resizable-panels.js
function He(e, t) {
...
function St({ groupId: e, panelId: t }) {
	let n = () => {
		...
		let r = a();
		if (e === r) return;
		let { defaultLayoutDeferred: i, derivedPanelConstraints: o, group: s, groupSize: c, layout: l, separatorToPanels: u } = n(), d = s.panels.findIndex((e) => e.id === t), f = d === s.panels.length - 1, p = q({
			layout: G({
				delta: f ? r - e : e - r,
				initialLayout: l,
				panelConstraints: o,
...
function hn({ children: e, className: t, disabled: n, disableDoubleClick: r, elementRef: i, id: a, style: o, ...s }) {
	...
	}), [u, d] = C({}), [f, p] = C("inactive"), m = S(null), h = an(m, i), { disableCursor: g, id: v, orientation: y, registerSeparator: b, updateSeparatorProps: x } = un(), w = y === "horizontal" ? "vertical" : "horizontal";
	$(() => {
		let e = m.current;
		if (e !== null) {
			let t = {
	...
	let T;
	return n && !g && (T = "not-allowed"), /* @__PURE__ */ E("div", {
		...s,
...
//# sourceMappingURL=layout-BST0lmSm.js.map