...
import { i as t, t as n } from "./button-CRJ9tpur.js";
import { b as r, c as i, d as a, g as o, l as s, o as c, p as l, s as u, u as d, v as f, y as p } from "./Combination-CTo9CVjQ.js";
import { t as m } from "./chevron-right-Csp3Jz6f.js";
import { t as h } from "./triangle-alert-CMhFyWgv.js";
import { t as g } from "./x-DU-kKGVx.js";
import { o as _, s as v, t as y } from "./dist-ZP7iWfNQ.js";
import { i as b, o as x, t as S } from "./dist-Dt-KO-jK.js";
import { _ as C, a as w, c as T, d as ee, f as te, g as ne, h as re, i as ie, l as ae, m as oe, n as se, o as ce, p as le, r as ue, s as de, t as fe, u as pe } from "./dist-CjkEqLdR.js";
import { _ as me, d as he, f as ge, g as _e, h as ve, m as ye, p as be, v as xe } from "./dialog-BI78tTI7.js";
import { t as Se } from "./dist-C1zeSBRY.js";
import * as E from "react";
import { Fragment as Ce, jsx as D, jsxs as O } from "react/jsx-runtime";
//#region ../../sdkwork-birdcoder/node_modules/.pnpm/@radix-ui+react-tooltip@1.2_368b427bd4a446fedecea5c055decde8/node_modules/@radix-ui/react-tooltip/dist/index.mjs
var [k, we] = _("Tooltip", [a]), A = a(), Te = "TooltipProvider", Ee = 700, j = "tooltip.open", [De, M] = k(Te), Oe = (e) => {
...
var N = "Tooltip", [ke, P] = k(N), Ae = (e) => {
	let { __scopeTooltip: t, children: n, open: r, defaultOpen: i, onOpenChange: a, disableHoverableContent: o, delayDuration: s } = e, c = M(N, e.__scopeTooltip), u = A(t), [p, m] = E.useState(null), h = l(), g = E.useRef(0), _ = o ?? c.disableHoverableContent, v = s ?? c.delayDuration, y = E.useRef(!1), [b, x] = f({
		prop: r,
		defaultProp: i ?? !1,
		onChange: (e) => {
...
Ae.displayName = N;
var F = "TooltipTrigger", je = E.forwardRef((e, t) => {
	let { __scopeTooltip: n, ...r } = e, i = P(F, n), a = M(F, n), o = A(n), s = x(t, E.useRef(null), i.onTriggerChange), c = E.useRef(!1), l = E.useRef(!1), d = E.useCallback(() => c.current = !1, []);
	return E.useEffect(() => () => document.removeEventListener("pointerup", d), [d]), /* @__PURE__ */ D(u, {
		asChild: !0,
		...o,
...
var L = "TooltipContent", Fe = E.forwardRef((e, t) => {
	...
	let n = P(L, e.__scopeTooltip), r = M(L, e.__scopeTooltip), i = E.useRef(null), a = x(t, i), [o, s] = E.useState(null), { trigger: c, onClose: l } = n, u = i.current, { onPointerInTransitChange: d } = r, f = E.useCallback(() => {
		s(null), d(!1);
		...
		if (o) {
			let e = (e) => {
				let t = e.target, n = {
					x: e.clientX,
					y: e.clientY
				}, r = c?.contains(t) || u?.contains(t), i = !Ke(n, o);
				r ? f() : i && (f(), l());
			};
...
}), [Le, Re] = k(N, { isInside: !1 }), ze = b("TooltipContent"), Be = E.forwardRef((e, t) => {
	let { __scopeTooltip: n, children: r, "aria-label": i, onEscapeKeyDown: a, onPointerDownOutside: c, ...l } = e, u = P(L, n), d = A(n), { onClose: f } = u;
...
var Ve = "TooltipArrow", He = E.forwardRef((e, t) => {
	let { __scopeTooltip: n, ...r } = e, a = A(n);
	return Re(Ve, n).isInside ? null : /* @__PURE__ */ D(i, {
		...a,
		...r,
		ref: t
	});
...
//#endregion
//#region ../../sdkwork-birdcoder/node_modules/.pnpm/@radix-ui+react-context-men_967799dada18215b7efc65bc4ce0db73/node_modules/@radix-ui/react-context-menu/dist/index.mjs
var R = "ContextMenu", [it, at] = _(R, [C]), z = C(), [ot, st] = it(R), ct = (e) => {
...
var Nt = "ContextMenuSub", Pt = (e) => {
	let { __scopeContextMenu: t, children: n, onOpenChange: r, open: i, defaultOpen: a } = e, o = z(t), [s, c] = f({
		prop: i,
		defaultProp: a ?? !1,
		onChange: r,
		caller: Nt
...
var sn = E.forwardRef(({ className: t, inset: n, children: r, ...i }, a) => /* @__PURE__ */ O(Qt, {
	...
	ref: a,
	...i,
	children: [r, /* @__PURE__ */ D(m, { className: "ml-auto h-4 w-4" })]
}));
...
var dn = E.forwardRef(({ className: t, children: n, checked: i, ...a }, o) => /* @__PURE__ */ O(Kt, {
	checked: i,
	...
	children: [/* @__PURE__ */ D("span", {
		...
		children: /* @__PURE__ */ D(Yt, { children: /* @__PURE__ */ D(r, { className: "h-4 w-4" }) })
	}), n]
}));
...
var fn = E.forwardRef(({ className: t, children: n, ...r }, i) => /* @__PURE__ */ O(Jt, {
	...
	children: [/* @__PURE__ */ D("span", {
		className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center",
		children: /* @__PURE__ */ D(Yt, { children: /* @__PURE__ */ D(p, { className: "h-2 w-2 fill-current" }) })
	}), n]
}));
...
var vn = t("fixed z-50 flex h-full flex-col border border-[var(--sdk-color-border-default)] bg-[var(--sdk-color-surface-panel)] text-[var(--sdk-color-text-primary)] shadow-[var(--sdk-shadow-lg)] outline-none", {
	defaultVariants: {
		side: "right",
		size: "md"
	},
	...
	children: [t, /* @__PURE__ */ O(H, {
		...
		children: [/* @__PURE__ */ D(g, { className: "h-4 w-4" }), /* @__PURE__ */ D("span", {
			className: "sr-only",
			children: "Close"
		})]
	})]
...
//#endregion
//#region ../../sdkwork-birdcoder/node_modules/.pnpm/@radix-ui+react-hover-card@_b1dd3a11e0e6025adf724f3de775860e/node_modules/@radix-ui/react-hover-card/dist/index.mjs
var W, G = "HoverCard", [Tn, En] = _(G, [a]), K = a(), [Dn, q] = Tn(G), On = (e) => {
	let { __scopeHoverCard: t, children: n, open: r, defaultOpen: i, onOpenChange: a, openDelay: o = 700, closeDelay: s = 300 } = e, c = K(t), l = E.useRef(0), u = E.useRef(0), p = E.useRef(!1), m = E.useRef(!1), [h, g] = f({
		prop: r,
		defaultProp: i ?? !1,
		onChange: a,
		caller: G
		...
		clearTimeout(l.current), !p.current && !m.current && (u.current = window.setTimeout(() => g(!1), s));
...
Pn.displayName = Y;
var Fn = E.forwardRef((e, t) => {
	let { __scopeHoverCard: n, onEscapeKeyDown: r, onPointerDownOutside: i, onFocusOutside: a, onInteractOutside: c, ...l } = e, u = q(Y, n), d = K(n), f = E.useRef(null), p = x(t, f), [m, h] = E.useState(!1);
	return E.useEffect(() => {
		if (m) {
			let e = document.body;
		...
		if (f.current) {
			...
			return document.addEventListener("pointerup", e), () => {
				document.removeEventListener("pointerup", e), u.hasSelectionRef.current = !1, u.isPointerDownOnContentRef.current = !1;
			};
		}
	}, [u.isPointerDownOnContentRef, u.hasSelectionRef]), E.useEffect(() => {
		f.current && Rn(f.current).forEach((e) => e.setAttribute("tabindex", "-1"));
	}), /* @__PURE__ */ D(o, {
		asChild: !0,
		disableOutsidePointerEvents: !1,
		onInteractOutside: c,
		...
		children: /* @__PURE__ */ D(s, {
			...d,
			...l,
			onPointerDown: v(l.onPointerDown, (e) => {
				e.currentTarget.contains(e.target) && h(!0), u.hasSelectionRef.current = !1, u.isPointerDownOnContentRef.current = !0;
			}),
			ref: p,
			style: {
				...l.style,
...
var Jn = t("fixed left-1/2 z-50 grid max-h-[min(88vh,56rem)] w-[min(92vw,40rem)] -translate-x-1/2 overflow-hidden rounded-[var(--sdk-radius-panel)] border border-[var(--sdk-color-border-default)] bg-[var(--sdk-color-surface-panel)] text-[var(--sdk-color-text-primary)] shadow-[var(--sdk-shadow-lg)] outline-none", {
	defaultVariants: {
		align: "center",
		size: "md"
	},
...
function nr({ cancelLabel: t = "Cancel", closeOnConfirm: r = !0, confirmLabel: i = "Confirm", confirmLoading: a = !1, description: o, onConfirm: s, onOpenChange: c, open: l, title: u, tone: d = "default" }) {
		...
		children: /* @__PURE__ */ O(Yn, {
			...
			children: [/* @__PURE__ */ D(Xn, { children: /* @__PURE__ */ O("div", {
				...
				children: [/* @__PURE__ */ D("div", {
					...
					children: /* @__PURE__ */ D(h, { className: "h-5 w-5" })
				}), /* @__PURE__ */ O("div", {
					className: "flex min-w-0 flex-1 flex-col gap-1",
					children: [/* @__PURE__ */ D($n, { children: u }), o ? /* @__PURE__ */ D(er, { children: o }) : null]
				})]
			}) }), /* @__PURE__ */ O(Qn, { children: [/* @__PURE__ */ D(n, {
				type: "button",
				variant: "secondary",
				onClick: () => c?.(!1),
				children: t
...
//# sourceMappingURL=overlays-DFG3Bynn.js.map