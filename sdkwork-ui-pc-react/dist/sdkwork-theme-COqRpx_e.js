...
function a(e, t) {
	return { brand: { ...i[e].brand[t] } };
}
function o(i, a) {
	return i === "claw" ? a === "light" ? t : e : a === "light" ? r : n;
}
function s(e, t) {
	return t ? {
		...e,
...
function c(e = {}) {
	let { colorMode: t = "dark", preset: n = "claw", themeColor: r = "lobster", ...i } = e, c = o(n, t), l = a(r, t);
	return s(c, {
		...l,
		...i,
		brand: {
...
function u(e, t = "lobster") {
	let n = i[t].palette;
	return {
		...l(e),
		"--theme-primary-50": n[50],
		"--theme-primary-100": n[100],
		"--theme-primary-200": n[200],
		"--theme-primary-300": n[300],
		"--theme-primary-400": n[400],
		"--theme-primary-500": n[500],
		"--theme-primary-600": n[600],
		"--theme-primary-700": n[700],
		"--theme-primary-800": n[800],
		"--theme-primary-900": n[900],
		"--theme-primary-950": n[950]
	};
}
function d(e) {
	return l(e);
...
//#endregion
export { c as a, d as c, r as i, t as n, l as o, n as r, u as s, e as t };

//# sourceMappingURL=sdkwork-theme-COqRpx_e.js.map