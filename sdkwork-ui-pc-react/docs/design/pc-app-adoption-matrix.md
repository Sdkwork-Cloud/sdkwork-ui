...
| `sdkwork-drive/sdkwork-drive-pc-react` | `@sdkwork/drive-ui`, near-duplicate of cloud UI | Tailwind CSS v4 | shadcn-compatible patterns, no registry file | Consolidate with cloud-derived primitives immediately after cloud baseline hardens |
